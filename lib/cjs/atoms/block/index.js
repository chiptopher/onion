...
var Block = function (_a) {
    var _b = _a.tagName, tagName = _b === void 0 ? 'div' : _b, color = _a.color, colorTint = _a.colorTint, padding = _a.padding, paddingTop = _a.paddingTop, paddingBottom = _a.paddingBottom, paddingRight = _a.paddingRight, paddingLeft = _a.paddingLeft, borderRadius = _a.borderRadius, margin = _a.margin, marginTop = _a.marginTop, marginBottom = _a.marginBottom, marginRight = _a.marginRight, marginLeft = _a.marginLeft, alignItems = _a.alignItems, rest = __rest(_a, ["tagName", "color", "colorTint", "padding", "paddingTop", "paddingBottom", "paddingRight", "paddingLeft", "borderRadius", "margin", "marginTop", "marginBottom", "marginRight", "marginLeft", "alignItems"]);
    ...
    return (react_1.default.createElement(Container, __assign({ alignItems: alignItems, as: tagName, borderRadius: borderRadius ? 4 : 0, margin: (0, resolve_padding_1.resolveBorderSpacing)({
            ...
            right: paddingRight,
            top: paddingTop,
        }) }, (0, resolve_colors_1.resolveColors)(theme, { color: color, tint: colorTint }), rest)));
};
exports.Block = Block;
