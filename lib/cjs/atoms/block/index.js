...
var Block = function (_a) {
    var _b = _a.tagName, tagName = _b === void 0 ? 'div' : _b, color = _a.color, padding = _a.padding, paddingTop = _a.paddingTop, paddingBottom = _a.paddingBottom, paddingRight = _a.paddingRight, paddingLeft = _a.paddingLeft, borderRadius = _a.borderRadius, margin = _a.margin, marginTop = _a.marginTop, marginBottom = _a.marginBottom, marginRight = _a.marginRight, marginLeft = _a.marginLeft, rest = __rest(_a, ["tagName", "color", "padding", "paddingTop", "paddingBottom", "paddingRight", "paddingLeft", "borderRadius", "margin", "marginTop", "marginBottom", "marginRight", "marginLeft"]);
    var theme = (0, theme_1.useTheme)();
    return (react_1.default.createElement(Container, __assign({ as: tagName, borderRadius: borderRadius ? 4 : 0, margin: (0, resolve_padding_1.resolveBorderSpacing)({
            all: margin,
            bottom: marginBottom,
            left: marginLeft,
            right: marginRight,
