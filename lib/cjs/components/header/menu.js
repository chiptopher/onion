...
var HeaderMenuItem = function (_a) {
    var _b = _a.contrasting, contrasting = _b === void 0 ? false : _b, cta = _a.cta, buttonProps = __rest(_a, ["contrasting", "cta"]);
    ...
    return (react_1.default.createElement("span", { className: "menu-item" },
        react_1.default.createElement(__1.Button, __assign({ color: color }, buttonProps))));
};
