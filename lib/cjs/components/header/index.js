...
var HeaderPrimaryNav = function (_a) {
    ...
    return (react_1.default.createElement(__1.Block, { color: inverted ? 'white' : 'primary', tagName: "div" },
        gutter ? (react_1.default.createElement(__1.Gutter, null,
            react_1.default.createElement(Container, null, children))) : (react_1.default.createElement(Container, null, children)),
...
var HeaderBrand = function (props) { return react_1.default.createElement("span", __assign({ className: "header-brand" }, props)); };
