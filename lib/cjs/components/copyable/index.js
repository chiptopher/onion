...
exports.CopyableContext = react_1.default.createContext({ copied: false, id: '', setCopied: console.log });
var Copyable = function (_a) {
    ...
    return (react_1.default.createElement(exports.CopyableContext.Provider, { value: { copied: copied, id: id, setCopied: setCopied } },
...
var CopyableContent = function (_a) {
    var children = _a.children;
    var id = react_1.default.useContext(exports.CopyableContext).id;
