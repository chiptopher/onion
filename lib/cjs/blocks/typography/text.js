...
var Text2 = function (_a) {
    var color = _a.color, tagName = _a.tagName, underlined = _a.underlined, style = _a.style, rest = __rest(_a, ["color", "tagName", "underlined", "style"]);
    var textColor = (0, theme_1.useTextColor)(color);
    var props = __assign({ as: tagName, color: (0, colors_1.resolveColorValue)(textColor) }, rest);
    switch (style) {
        case 'title':
