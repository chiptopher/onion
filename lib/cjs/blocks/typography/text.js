...
var Text2 = function (_a) {
    ...
    switch (style) {
        ...
        case 'larger-body':
            return react_1.default.createElement(LargerBodyTag, __assign({}, props));
    }
};
exports.Text2 = Text2;
...
var LargerBodyTag = (0, styled_components_1.default)(Container)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    font-size: 1.2rem;\n"], ["\n    font-size: 1.2rem;\n"])));
