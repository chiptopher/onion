...
var FormInput = function (_a) {
    ...
    return (react_1.default.createElement(wrapper_1.Wrapper, __assign({}, wrapperProps, { htmlFor: id }),
        react_1.default.createElement("input", { disabled: disabled, id: id, onChange: onChange, placeholder: placeholder, type: "text", value: value })));
};
exports.FormInput = FormInput;
exports.FormInput.displayName = 'Form.Input';
