...
function breakpoint(lower, upper) {
    return {
        lower: lower,
        upper: upper,
    };
...
var useTheme = function () { return react.exports.useContext(ThemeContext); };
/*
 * @deprecated
 */
...
var Text2 = function (_a) {
    var color = _a.color, tagName = _a.tagName; _a.underlined; var style = _a.style, rest = __rest(_a, ["color", "tagName", "underlined", "style"]);
    var textColor = useTextColor(color);
    var props = __assign({ as: tagName, color: resolveColorValue(textColor) }, rest);
    switch (style) {
        case 'title':
...
var Container$i = qe.div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n    color: ", ";\n    ", ";\n    font-family: 'Nunito', sans-serif;\n    margin: 0;\n    padding: 0;\n    ", "\n    cursor: inherit;\n"], ["\n    color: ", ";\n    ", ";\n    font-family: 'Nunito', sans-serif;\n    margin: 0;\n    padding: 0;\n    ", "\n    cursor: inherit;\n"])), function (props) { return props.color; }, function (props) { return props.marginBottom && "margin-bottom: ".concat(block(1.5)); }, function (props) { return props.underlined && 'text-decoration: underline'; });
var TitleStyleTag = qe(Container$i)(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n    font-size: 2.75rem;\n    font-weight: bold;\n"], ["\n    font-size: 2.75rem;\n    font-weight: bold;\n"])));
var BodyStyleTag = qe(Container$i)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n    font-size: 1rem;\n"], ["\n    font-size: 1rem;\n"])));
var CaptionStyleTag = qe(Container$i)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    font-size: 0.8rem;\n"], ["\n    font-size: 0.8rem;\n"])));
var HeaderStyleTag = qe(Container$i)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    font-size: 1.75rem;\n    font-weight: bold;\n"], ["\n    font-size: 1.75rem;\n    font-weight: bold;\n"])));
var SubheaderStlyeTag = qe(Container$i)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    font-size: 1.5rem;\n    margin-bottom: ", ";\n"], ["\n    font-size: 1.5rem;\n    margin-bottom: ", ";\n"])), block(1.5));
var LabelStyleTag = qe(Container$i)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    font-weight: bold;\n    margin-bottom: ", ";\n    font-size: 1rem;\n"], ["\n    font-weight: bold;\n    margin-bottom: ", ";\n    font-size: 1rem;\n"])), block(1));
var templateObject_1$k, templateObject_2$2, templateObject_3$1, templateObject_4, templateObject_5, templateObject_6, templateObject_7;

var Label = function (props) {
    return React.createElement(Text2, __assign({ marginBottom: "1", style: "label", tagName: "label" }, props));
};
...
var Button = function (_a) {
    ...
    return (React.createElement(Container$h, __assign({ backgroundColor: resolveColorValue(unresolvedBackgroundColor, 'regular'), color: textColor, hoverBackgroundColor: resolveColorValue(unresolvedBackgroundColor, 'dark'), padding: padding, type: type || 'button' }, rest),
        React.createElement(Label, null, children)));
};
var Container$h = qe.button(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n    background-color: ", ";\n    border-radius: 4px;\n    border: none;\n    color: ", ";\n    padding: ", ";\n\n    cursor: pointer;\n\n    &:hover {\n        background-color: ", ";\n    }\n"], ["\n    background-color: ", ";\n    border-radius: 4px;\n    border: none;\n    color: ", ";\n    padding: ", ";\n\n    cursor: pointer;\n\n    &:hover {\n        background-color: ", ";\n    }\n"])), function (props) { return props.backgroundColor; }, function (props) { return props.color; }, function (props) { return props.padding; }, function (props) { return props.hoverBackgroundColor; });
var buttonPadding = {
...
var StyledTag = qe.div(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n    text-decoration: underline;\n    border: none;\n    background-color: transparent;\n    padding: 0;\n    color: ", ";\n    cursor: pointer;\n"], ["\n    text-decoration: underline;\n    border: none;\n    background-color: transparent;\n    padding: 0;\n    color: ", ";\n    cursor: pointer;\n"])), function (props) { return props.color; });
var templateObject_1$i;

var LoadingContext = react.exports.createContext({
    loading: false,
    setLoading: console.log,
});
function useLoading() {
    var _a = react.exports.useContext(LoadingContext), loading = _a.loading, setLoading = _a.setLoading;
...
var Dots = function () {
    ...
    return (React.createElement(Body, null,
        React.createElement(Container$g, null,
            dots > 0 && React.createElement("span", null, "\u2022"),
            dots > 1 && React.createElement("span", null, "\u2022"),
            dots > 2 && React.createElement("span", null, "\u2022"))));
};
var Container$g = qe.span(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n    span {\n        margin-right: ", ";\n    }\n"], ["\n    span {\n        margin-right: ", ";\n    }\n"])), block(1));
...
var Body = function (_a) {
    var _b = _a.tagName, tagName = _b === void 0 ? 'p' : _b, rest = __rest(_a, ["tagName"]);
    return React.createElement(Text2, __assign({ style: "body", tagName: tagName }, rest));
};

var Caption = function (_a) {
    var _b = _a.tagName, tagName = _b === void 0 ? 'p' : _b, rest = __rest(_a, ["tagName"]);
    return React.createElement(Text2, __assign({ style: "caption", tagName: tagName }, rest));
};

var Header = function (_a) {
    var heirarchy = _a.heirarchy, rest = __rest(_a, ["heirarchy"]);
    return (React.createElement(Text2, __assign({ marginBottom: "1.5", style: "header", tagName: "h".concat(heirarchy) }, rest)));
};

var Subheader = function (_a) {
    var heirarchy = _a.heirarchy, rest = __rest(_a, ["heirarchy"]);
    return (React.createElement(Text2, __assign({ marginBottom: "1.5", style: "subheader", tagName: "h".concat(heirarchy) }, rest)));
};

var Title = function (_a) {
    var heirarchy = _a.heirarchy, rest = __rest(_a, ["heirarchy"]);
    return (React.createElement(Text2, __assign({ marginBottom: "1.5", style: "title", tagName: "h".concat(heirarchy) }, rest)));
};
...
var Container$f = qe.div(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n    ol {\n        list-style-type: none;\n        margin: 0;\n        padding: 0;\n        display: flex;\n        list-style-type: none;\n\n        li:before {\n            content: '/';\n            margin: ", " ", ";\n        }\n    }\n"], ["\n    ol {\n        list-style-type: none;\n        margin: 0;\n        padding: 0;\n        display: flex;\n        list-style-type: none;\n\n        li:before {\n            content: '/';\n            margin: ", " ", ";\n        }\n    }\n"])), block(1.5), block(1.5));
...
var Block = function (_a) {
    ...
    var theme = useTheme();
    return (React.createElement(Container$e, __assign({ as: tagName, borderRadius: borderRadius ? 4 : 0, padding: resolvePadding(padding) }, resolveColors(theme, color), rest)));
};
var Container$e = qe.div(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n    background-color: ", ";\n    color: ", ";\n    padding: ", ";\n\n    margin-bottom: 1rem;\n\n    border-radius: ", "px;\n"], ["\n    background-color: ", ";\n    color: ", ";\n    padding: ", ";\n\n    margin-bottom: 1rem;\n\n    border-radius: ", "px;\n"])), function (props) { return props.backgroundColor; }, function (props) { return props.color; }, function (p) { return p.padding; }, function (p) { return p.borderRadius; });
var templateObject_1$f;

var Buttons = function (_a) {
    var children = _a.children;
    return (React.createElement(Block, null,
        React.createElement(Container$d, null, children)));
};
var Container$d = qe.div(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n    button {\n        margin-right: ", ";\n    }\n"], ["\n    button {\n        margin-right: ", ";\n    }\n"])), block(1));
...
var Container$c = qe(Caption)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n    margin-bottom: ", ";\n"], ["\n    margin-bottom: ", ";\n"])), block(1.5));
...
var Container$b = qe(Caption)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n    margin-bottom: ", ";\n"], ["\n    margin-bottom: ", ";\n"])), block(1.5));
...
var Container$a = qe.li(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n    margin-bottom: ", ";\n"], ["\n    margin-bottom: ", ";\n"])), block(0.5));
var templateObject_1$b;

var FooterTitle = function (_a) {
    var children = _a.children;
    return React.createElement(Subheader, { heirarchy: "2" }, children);
};

var Footer = function (_a) {
    var children = _a.children;
    var theme = useTheme();
    return (React.createElement(Container$9, { bc: resolveColorValue(theme.base.grey, 'light') }, children));
};
var Container$9 = qe.footer(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n    background-color: ", ";\n    padding: ", " 0 ", ";\n    text-align: center;\n"], ["\n    background-color: ", ";\n    padding: ", " 0 ", ";\n    text-align: center;\n"])), function (props) { return props.bc; }, block(6), block(3));
var NavContainer = qe.nav(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n    margin-bottom: ", ";\n\n    ol {\n        list-style-type: none;\n        margin: 0;\n        padding: 0;\n    }\n"], ["\n    margin-bottom: ", ";\n\n    ol {\n        list-style-type: none;\n        margin: 0;\n        padding: 0;\n    }\n"])), block(4));
...
var ListItem = function (_a) {
    var children = _a.children;
    var theme = useTheme();
    return (React.createElement(Container$8, { c: resolveColorValue(theme.base.grey, 'regular') }, children));
};
var Container$8 = qe.li(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n    padding: ", " ", ";\n\n    &:nth-child(odd) {\n        background-color: ", ";\n    }\n"], ["\n    padding: ", " ", ";\n\n    &:nth-child(odd) {\n        background-color: ", ";\n    }\n"])), block(0.5), block(1), function (p) { return p.c; });
var templateObject_1$9;

var List = function (_a) {
    var children = _a.children;
    return React.createElement(Container$7, null, children);
};
var Container$7 = qe.ul(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n    margin: 0;\n    padding: 0;\n    list-style-type: none;\n"], ["\n    margin: 0;\n    padding: 0;\n    list-style-type: none;\n"])));
List.Item = ListItem;
...
var ModalContent = function (_a) {
    ...
    return open ? (React.createElement(Container$6, null,
...
var Container$6 = qe.div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n"], ["\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n"])));
var Shadow = qe.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n\n    background-color: rgba(0, 0, 0, 0.5);\n"], ["\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n\n    background-color: rgba(0, 0, 0, 0.5);\n"])));
var ContentContainer = qe.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 100%;\n\n    & > div {\n        background-color: white;\n        padding: ", ";\n        z-index: 99;\n        border-radius: 4px;\n    }\n"], ["\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 100%;\n\n    & > div {\n        background-color: white;\n        padding: ", ";\n        z-index: 99;\n        border-radius: 4px;\n    }\n"])), block(2));
var templateObject_1$7, templateObject_2, templateObject_3;
...
var SectionAction = function (props) {
    return React.createElement("span", { className: "action" }, props.children);
};

var SectionHeader = function (_a) {
    var children = _a.children;
    return React.createElement(Container$5, null, children);
};
var Container$5 = qe.div(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n\n    h1,\n    h2,\n    h3,\n    h4,\n    h5,\n    h6 {\n        margin-bottom: 0;\n    }\n\n    margin-bottom: ", ";\n"], ["\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n\n    h1,\n    h2,\n    h3,\n    h4,\n    h5,\n    h6 {\n        margin-bottom: 0;\n    }\n\n    margin-bottom: ", ";\n"])), block(2));
...
var Container$4 = qe.div(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n    margin-bottom: 3rem;\n"], ["\n    margin-bottom: 3rem;\n"])));
...
var TH = qe.th(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n    text-align: left;\n"], ["\n    text-align: left;\n"])));
var templateObject_1$4;

var TableHeader = function (_a) {
    var children = _a.children;
    var theme = useTheme();
    return (React.createElement(Container$3, { color: resolveColorValue(theme.base.grey) },
        React.createElement("tr", null, children)));
};
var Container$3 = qe.thead(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject([""], [""])));
...
var Table = function (_a) {
    var children = _a.children;
    var theme = useTheme();
    return (React.createElement(Container$2, { oddRowBackgroundColor: resolveColorValue(theme.base.grey) }, children));
};
var Container$2 = qe.table(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n    border-collapse: collapse;\n    table-layout: fixed;\n\n    thead {\n        th {\n            border-bottom: solid 1px black;\n            padding-right: ", ";\n        }\n    }\n\n    tbody {\n        vertical-align: top;\n\n        tr:nth-child(even) {\n            background-color: ", ";\n        }\n    }\n"], ["\n    border-collapse: collapse;\n    table-layout: fixed;\n\n    thead {\n        th {\n            border-bottom: solid 1px black;\n            padding-right: ", ";\n        }\n    }\n\n    tbody {\n        vertical-align: top;\n\n        tr:nth-child(even) {\n            background-color: ", ";\n        }\n    }\n"])), block(3), function (p) { return p.oddRowBackgroundColor; });
...
var Wrapper = function (_a) {
    ...
    var theme = useTheme();
    return (React.createElement(Container$1, { borderColor: resolveColorValue(theme.base.grey, 'regular') },
        label && React.createElement(Label, { htmlFor: htmlFor }, label),
        React.createElement("div", null, children),
        React.createElement(HelpText, { help: help })));
};
var Container$1 = qe.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n    margin-bottom: ", ";\n\n    input,\n    textarea {\n        border-radius: 4px;\n        width: 100%;\n        border: solid 1px ", ";\n        font-size: 1rem;\n        padding: 0.25rem 0.25rem;\n    }\n"], ["\n    margin-bottom: ", ";\n\n    input,\n    textarea {\n        border-radius: 4px;\n        width: 100%;\n        border: solid 1px ", ";\n        font-size: 1rem;\n        padding: 0.25rem 0.25rem;\n    }\n"])), block(1), function (p) { return p.borderColor; });
...
var FormColor = function (_a) {
    ...
    return (React.createElement(Wrapper, __assign({}, wrapperProps),
        React.createElement("input", { disabled: disabled, id: id, onChange: onChange, placeholder: placeholder, type: "color", value: value })));
};
...
var FormTextarea = function (_a) {
    ...
    return (React.createElement(Wrapper, __assign({}, wrapperProps, { htmlFor: id }),
        React.createElement("textarea", { className: "input", disabled: disabled, id: id, onChange: onChange, placeholder: placeholder, rows: rows, value: value })));
};

/* eslint-disable react/display-name */
var _Form = function (_a) {
    var onReset = _a.onReset, onSubmit = _a.onSubmit, children = _a.children, props = __rest(_a, ["onReset", "onSubmit", "children"]);
    var _b = useLoading(), setLoading = _b[1];
    return (React.createElement("form", __assign({ onSubmit: function (e) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                e.preventDefault();
                setLoading(true);
                return [2 /*return*/, onSubmit().then(function () { return setLoading(false); })];
            });
        }); }, onReset: onReset }, props), children));
};
var Form = function (props) { return (React.createElement(Loading, null,
    React.createElement(_Form, __assign({}, props)))); };
Form.Buttons = function () { return (React.createElement(Buttons, null,
...
export { Body, Breadcrumbs, Button, Buttons, Caption, Footer, Form, Gutter, Header, Label, Link, List, Loading, Modal, Section, Subheader, Table, Text2 as Text, ThemeProvider, Title, block, useLoading, withLoading };
